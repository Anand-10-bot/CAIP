...
class SarvamProvider(BaseProvider):
    ...
    (/chat/completions), so we use httpx directly rather than importing an
    SDK. The caller's code is identical to calling any other provider.
    """
    ...
    def _build_payload(
        ...
        # Reasoning effort (Sarvam-specific)
